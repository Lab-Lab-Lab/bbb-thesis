...
\advisor{Michael Stewart, Ph.D} 
\advisorrank{Associate Professor}
\advisordept{Computer Science}

\firstmember{Dee A. B. Weikle, Ph.D}
\firstmemberRole{Reader}
\firstrank{Professor}
\firstdept{Computer Science}


\secondmember{Christopher Johnson, Ph.D}
\secondmemberRole{Reader}
\secondrank{Associate Professor}
\seconddept{Computer Science}


\thirdmember{Possible Other Professor, Ph.D}
\thirdmemberRole{Reader}
\thirdrank{Title}
\thirddept{Department}

\presentLocation{King Room XXX}
\presentDate{Date TBD}

\deanHonorsCollege{Honor's College Dean, Ph.D.}
